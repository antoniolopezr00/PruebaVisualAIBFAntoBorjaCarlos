...
urlpatterns = [
    ...
    path('app-profile/',aibf_views.app_profile,name="app-profile"),
    path('edit-profile/',aibf_views.edit_profile,name="edit-profile"),
    path('post-details/',aibf_views.post_details,name="post-details"),
    path('email-compose/',aibf_views.email_compose,name="email-compose"),
    path('email-inbox/',aibf_views.email_inbox,name="email-inbox"),
    path('email-read/',aibf_views.email_read,name="email-read"),
    ...
    path('email-template/',aibf_views.email_template,name="email-template"),
    path('add-email/',aibf_views.add_email,name="add-email"),
